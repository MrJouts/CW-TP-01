/**
 *	Trae un listado de las reservas cargadas
 *	
 */
hc.getReservas = function() {
	...
	hc.ajax({
		...
		success: function(rta) {
			...
			// Armo la variable salida con todos los datos que trae de la consulta
			var salida = "";
			...
			if (hc.$('getReserva')) {
				// cargo los datos en el HTML y llamo a las funciones de alta
				// baja y modificación
