	...
	hc.ajax({
		...
		success: function(rta) {
			...
			for(let i = 0; i < reservas.length; i++) {
				...
				salida += '<td>';
				salida += '<button id="reserva-editar" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Editar"><i class="glyphicon glyphicon-pencil"></i> <span class="sr-only">Editar</span></button> ';
				salida += '<button id="reserva-ver" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Borrar"><i class="glyphicon glyphicon-remove"></i> <span class="sr-only">Borrar</span></button>';
				salida += "</td>";
				salida += "</tr>";
			}
