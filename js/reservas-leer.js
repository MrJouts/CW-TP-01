		...
		hc.ajax({
			...
			success: function(rta) {
				...
				for(let i = 0; i < reservas.length; i++) {
					...
					salida += '<td>';
					salida += '<button id="reservaEditar" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" value="'+reservas[i].id_reserva+'" title="Editar"><i class="glyphicon glyphicon-pencil"></i> <span class="sr-only">Editar</span></button> ';
